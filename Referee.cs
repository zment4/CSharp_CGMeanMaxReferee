...
abstract public class MultiReferee : AbstractReferee
{
    ...
    public void DumpProperties() => properties.Save(output);
...
abstract public class AbstractReferee
{
    ...
    public void start()
    {
        ...
        {
            error.WriteLine(e.getReason());
            if (this is MultiReferee)
                (this as MultiReferee).DumpProperties();
        }
    }
...
public class Properties : Hashtable
{
    ...
    internal void Save(TextWriter output)
    {
        foreach (var propKey in Keys)
        {
            output.WriteLine(propKey + "=" + this[propKey]);
        }
    }
